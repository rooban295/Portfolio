  ...
  return (
    ...
    <div className='flex flex-col md:flex-row gap-5'>
        ...
        <div className='flex flex-col items-center px-5 gap-5 rounded-lg p-5 skills-Welcome-box'>
            ...
            <h1 className='text-white text-xl font-bold'>Project Name: E-commerce website <span className='text-sm'>(FULLSTACK)</span></h1>
        ...
        <div className='flex flex-col px-5 gap-5  rounded-lg p-5 skills-Welcome-box'>
            <div className=''>
            ...
            <h1 className='text-white text-xl font-bold'>Project Name: Employee Management System <span className='text-sm'>(CRUD)</span></h1>
        ...
        <div className='flex flex-col px-5 gap-5 rounded-lg p-5 skills-Welcome-box'>
            ...
            <div className='text-white flex-col gap-2'>
            <h1 className='text-white text-xl font-bold'>Project Name: Weather-App <span className='text-sm'>(MOCK API)</span></h1>
