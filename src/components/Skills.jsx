...
export const Skills = () => {
  return (
    <div id='skills' className='mt-28'>
      ...
      <div className='flex  gap-5 mt-10 justify-evenly flex-wrap '>

        <div className='skills-Welcome-box border h-[210px] w-[200px] p-[20px] border-[#7042f88b] opacity-[0.9 text-[#b49bff] text-[15px] rounded-lg'>
        ...
        <div className='skills-Welcome-box border h-[210px] w-[200px] p-[20px] border-[#7042f88b] opacity-[0.9 text-[#b49bff] text-[15px] rounded-lg'v>
